...
from .admin_cost_preview import (
    build_cost_preview_rows,
...
class SQLiteAdminRepo:
    ...
    def _build_cost_preview_rows(
        ...
        return build_cost_preview_rows(items, ingredient_names, prices, conv)
